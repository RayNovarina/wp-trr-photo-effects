...
if ( trr_loader_globals.photos.length == 0 ) {
  ...
  trr_log( trr_loader_globals.log_id + "  ..*1f: scripts_to_be_loaded = " + trr_loader_globals.scripts_to_be_loaded.length +
  ...
  jQuery.each( trr_loader_globals.scripts_to_be_loaded, function( index, url_src ) {
    ...
    jQuery.getScript( url_src )
      .done(function( script, textStatus ) {
        ...
        trr_log( trr_loader_globals.log_id + "  ..*1e(" + trr_loader_globals.scripts_remaining_to_finish_loading_count +
                 " remaining): '" +
      ...
      .fail(function( jqxhr, settings, exception ) {
        trr_loader_globals.scripts_remaining_to_finish_loading_count --;
        console.log( trr_loader_globals.log_id + "  ..*1f(" + trr_loader_globals.scripts_remaining_to_finish_loading_count +
                     " remaining): " +
