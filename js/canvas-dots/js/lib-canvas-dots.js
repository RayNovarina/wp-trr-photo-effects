...
CanvasDotsPlugin.prototype = {
  ...
  init: function( parms, callback ) {
    // Note: this.$el = <img class="trr-photo-effect title="photo_url halftone_url"/>
    var $el = this.$el;
    trr_statusLog( "  ..*6.1d.6-CanvasDotsPlugin init for el.id: '" + $el.attr('id') +
                   "' action: '" + parms.action + "' *");
    ...
    */
    trr_dots_effect_getTheJpeqImageData( this, $el, parms,
    ...
    */
    ...
    trr_dots_effect_initSceneData( this, $el, parms,
  ...
  renderFunc: function(a) {
    var $el = this.$el;
    //trr_statusLog( "  ..*6.1d.15-CanvasDotsPlugin renderFunc: action '" + $el.attr('render_action') +
